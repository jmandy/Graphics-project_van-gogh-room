...
void draw_bed()
{
	...
	glBindTexture(GL_TEXTURE_2D, texture[0]);
	glPushMatrix();
	glTranslatef(11.3, 2.5, 20); //11.3 2.5 -16
	glScalef(1.5, 2.5, 6);//1.5 2.5 6
	draw_solid_cube(1);
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
...
void display(void)
{
	...
	//draw_chair(0.0, 0, 0);x
	//draw_chair(12.0, 0, 3);
	draw_chair(23.0, 5.8, 2);
...
int main(int argc, char **argv)
{
	...
	char file1[100] = "C:\\Users\\jmand\\Documents\\GitHub\\3D-Room\\bed_sheet.bmp";
	char file2[100] = "C:\\Users\\jmand\\Documents\\GitHub\\3D-Room\\wall.bmp";
	char file3[100] = "C:\\Users\\jmand\\Documents\\GitHub\\3D-Room\\floor.bmp";
	char *pt, *pt2, *pt3;
	pt = file1;
	pt2 = file2;
	pt3 = file3;
	...
	loadTexture(pt, 0);  //Give full path of image else it will not work
	loadTexture(pt2, 1);
